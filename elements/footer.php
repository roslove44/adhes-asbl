            ...
            <div class="col-lg-6 col-sm-6">
              <div class="footer-box mb-md-80">
                ...
                <ul class="custom links">
                  <li>
                    <a href="about.php" class="text-custom-white">A propos</a>
                  </li>
                  <li>
                    <a href="service-detail?service=ventes.php" class="text-custom-white">Services</a>
                  </li>
                  <li>
                    <a href="formation.php" class="text-custom-white">Formation</a>
                  </li>
                  <li>
          ...
          <div class="row">
            <div class="col-lg-6">
              <p class="text-custom-white no-margin">
                © ADHES ADSL - 2020 | All Right Reserved.
                <a
                  href="https://wa.me/+22966534131"
                  target="_blank"
